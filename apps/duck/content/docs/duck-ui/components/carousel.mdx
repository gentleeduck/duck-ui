...
| `...props` | `React.HTMLAttributes<HTMLUListElement>` | - | Additional props to spread to the underlying `ul` element (wrapped in an unstyled `overflow-hidden` div that holds the Embla ref) |
