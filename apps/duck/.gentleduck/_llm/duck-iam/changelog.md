...
* 62e3d0b: Add an optional `IConfig.maxConcurrentSubjectLoads` cap (default `0` = unbounded,
  ...
  described in `SCALING.md` section 8. `resolveSubject` rejects a *new* subject load once
...
declared the source tree exhausted: *"the package is genuinely hard to break."*
