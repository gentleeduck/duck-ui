...
<ComponentPreview
  name="popover-5"
  description="A popover with an active trigger style when open."
/>
...
<ComponentPreview
  name="popover-7"
  description="A popover with an arrow pointing at the trigger."
/>
...
<ComponentPreview
  name="popover-6"
  description="A popover with motion-powered spring animations."
/>
...
Adds a `scaleIn` enter/exit animation (fade, scale, and blur) with a `springSnappy` transition. Requires the `motion` package.
