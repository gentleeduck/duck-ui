...
describe the message registry, giving compile-time safety for i18n dictionaries, error codes,
...
The object **keys** become the message keys. Values can be anything, since Duck Gen only uses
the keys.
