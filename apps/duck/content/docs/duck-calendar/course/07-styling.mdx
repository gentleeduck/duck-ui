---
title: "Lesson 7: Styling"
description: "Using data attributes to style the calendar with Tailwind or plain CSS."
section: Course
order: 7
---
<Callout icon={<Lightbulb />}>

**Lesson 7 of 8**: style every part of the calendar with data attributes, with no CSS imports and no specificity wars.
