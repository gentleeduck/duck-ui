---
title: theme
description: Manage theme tokens: list available themes, inspect color values, install one into your globals.css.
section: Commands
---
## Usage
...
Re-running `theme add` with another name **replaces the block in place**, so swapping themes is a one-command operation:
