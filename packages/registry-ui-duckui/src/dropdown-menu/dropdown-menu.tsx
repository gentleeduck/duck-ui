...
function DropdownMenuTrigger({
	...
	return (
		<PopoverTrigger
			...
			className={cn(
				"font-normal data-[open=true]:bg-secondary data-[open=true]:text-accent-foreground",
				className,
			)}
			{...props}
		>
...
function DropdownMenuLabel({
	...
	return (
		<label
			...
			ref={ref}
			className={cn(
				"px-2 py-1.5 text-muted-foreground text-xs font-semibold",
				inset && "pe-8",
				className,
			)}
			{...props}
...
function DropdownMenuGroup({
	...
	return (
		<div className={cn(className)} {...props} duck-dropdown-menu-group="" />
	);
}
...
function DropdownMenuRadioGroup({
	...
	return (
		<RadioGroup
			duck-dropdown-menu-radio-group=""
			duck-dropdown-menu-group=""
			{...props}
		/>
	);
}
...
function DropdownMenuRadioItem({
	...props
}: React.ComponentPropsWithRef<typeof RadioGroupItem>) {
