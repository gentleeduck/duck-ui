...
export type IMotionCalendarHeaderProps = ICalendarHeaderProps
...
export function MotionCalendarHeader({
  adapter: adapterProp,
  month,
  title,
  direction,
...
MotionCalendarHeader.displayName = 'MotionCalendarHeader'
