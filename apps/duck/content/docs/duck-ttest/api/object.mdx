---
title: object
description: Deep transforms, key arithmetic, dotted-path access, case conversion: the broadest module.
section: API
order: 26
---
...
Shallow and deep variants for camelCase, PascalCase, snake_case, kebab-case:
