...
<ComponentPreview
  ...
  description="A dropdown menu with an active trigger style when open."
/>

### Arrow

Add a directional caret pointing at the trigger. Place `<DropdownMenuArrow />` anywhere inside `DropdownMenuContent`: it positions itself automatically.

<ComponentPreview
  name="dropdown-menu-7"
  description="A dropdown menu with an arrow pointing at the trigger."
/>
...
<ComponentPreview
  ...
  description="A dropdown menu with motion-powered spring animations."
/>
