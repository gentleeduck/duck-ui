---
title: MCP Server
description: Connect AI tools like Claude, Cursor, and Windsurf to the gentleduck documentation through the Model Context Protocol, for live access to every package's docs, APIs, and examples.
section: Tooling
---
...
Get only the code examples from a documentation page. Returns all fenced code blocks without surrounding prose, saving tokens when you just need usage patterns.
